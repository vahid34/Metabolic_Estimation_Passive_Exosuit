...
% read the muscle properties - updated for passive moment inputs ----------
...
SolverSetup.optionssol.ipopt.max_iter = 500;
...
if Misc.MRSBool == 1
    for trial = 1:Misc.nTrials  
        ...
        MuscProperties.kpe= Misc.kpe';  % kpe
        MuscProperties.ksf= Misc.ksf';  % ksf
        MuscProperties.ke0= Misc.ke0';  % ke0
